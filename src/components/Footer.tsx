...
function Footer() {
  return (
    <div className="bg-gray-800">
      <div className="px-4 pt-16 sm:px-6 lg:px-8 max-w-[1600px] mx-auto">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-gray-400">
                ...
                Provident reiciendis enim doloremque! Repellendus placeat
                repellat totam,
              </p>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              ...
              <a
                ...
                title="Our phone"
                className="text-gray-400 transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
              >
                850-123-5021
              </a>
            </div>
